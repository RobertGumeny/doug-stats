...
### Added
- Added API-level sort support for /api/tasks and /api/sessions, documented supported query parameters, and expanded API tests for sort ordering and invalid sort handling.
